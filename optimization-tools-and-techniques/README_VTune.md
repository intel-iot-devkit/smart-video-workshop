...
Keep the Text Editor open, hold **Ctrl** key and click this link: [[object_detection_demo_ssd_async.hpp](https://github.com/intel-iot-devkit/smart-video-workshop/blob/master/optimization-tools-and-techniques/object_detection_demo_ssd_async.hpp?raw=true)], copy all the source code into your opened **object_detection_demo_ssd_async.hpp** file, click save and close the text editor.
...
**_-i /home/intel/Downloads/head-pose-face-detection-female-and-male.mp4 -m /opt/intel/openvino/deployment_tools/open_model_zoo/tools/downloader/intel/face-detection-retail-0004/FP16/face-detection-retail-0004.xml_**
