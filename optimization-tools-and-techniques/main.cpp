    ...
    try {
        ...
        while (framenum < 500) {
            ...
            if (OK == async_infer_request_curr->Wait(IInferRequest::WaitMode::RESULT_READY)) {
                ...
                out.str("");
                out << "Wallclock time " << (isAsyncMode ? "(TRUE ASYNC):      " : "(SYNC): ");
        ...
        std::cout << "Total Inference time: " << total.count() << "ms"<< std::endl;
        // Calculate FPS
        std::cout << "Framenum: " << framenum << std::endl;
        std::cout << "FPS: " << (framenum/(total.count()/1000)) << std::endl;
